  ...
  private getApplicationConfig(appRootUrl: string, callback: () => void) {
    this._httpClient
      ...
      .subscribe((response) => {
        ...
        AppConsts.reportUrl = response.reportUrl;  
        AppConsts.reportFolder = response.reportFolder;
        AppConsts.reportWidth = response.reportWidth;
        AppConsts.reportHeight = response.reportHeight;
        AppConsts.reportToolbar = response.reportToolbar;
        AppConsts.reportLanguage = response.reportLanguage;
        callback();
      });
  }
}
